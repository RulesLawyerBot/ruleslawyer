...
@Deprecated
public class GenericHelpMessageService {

    public static final String MAIN_HELP_STRING = "Hello!\n" +
            "\n" +
    ...
    public static final String HELP_ADVANCED_STRING = "**RulesLawyer: advanced usage**\n" +
            "\n" +
    ...
    public static final String HELP_ABOUT_STRING = "**About RulesLawyer**\n" +
            "\n" +
    ...
    public static final String HELP_ADD_STRING = "Add **RulesLawyer** to your own server by using this link: https://discordapp.com/oauth2/authorize?client_id=590184543684788253&scope=bot&permissions=2147838016";

    public static final String HELP_DEV_STRING = "```\n" +
    ...
    public static final String HELP_NOT_FOUND_STRING = "I don't have that help file. Use {{help}} for the main help file.";

    private HashMap<String, String> helpFiles;

    public GenericHelpMessageService() {
        helpFiles = new HashMap<>();
        helpFiles.put("advanced", HELP_ADVANCED_STRING);
        helpFiles.put("add", HELP_ADD_STRING);
        helpFiles.put("about", HELP_ABOUT_STRING);
        helpFiles.put("dev", HELP_DEV_STRING);
    }

    public String getHelpFile() {
        return MAIN_HELP_STRING;
    }

    public String getHelpFile(String query) {
        return helpFiles.getOrDefault(query, HELP_NOT_FOUND_STRING);
    }
}
