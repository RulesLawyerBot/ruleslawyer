...
public class ReactionPaginationServiceTest {
    ...
    public void ParseEmbeddedRequest() {
        ...
        DiscordSearchRequest expectedNonspecificResult = new DiscordSearchRequest("Elaine", "", asList("mana", "symbol"), ANY_DOCUMENT, 1, ANY_RULE_TYPE);
        ...
        DiscordSearchRequest expectedSpecificResult = new DiscordSearchRequest("Elaine", "", asList("mana", "symbol"), CR, 1, ANY_RULE_TYPE);
