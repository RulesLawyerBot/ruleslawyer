...
public class ReactionPaginationServiceTest {
    ...
    public void ParseEmbeddedRequest() {
        ...
        DiscordSearchRequest expectedNonspecificResult = new DiscordSearchRequest("Elaine", "TO BE IMPLEMENTED", asList("mana", "symbol"), ANY_DOCUMENT, 1, PAPER);
        ...
        DiscordSearchRequest expectedSpecificResult = new DiscordSearchRequest("Elaine", "TO BE IMPLEMENTED", asList("mana", "symbol"), CR, 1, PAPER);
